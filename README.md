...
This is a minimal agent built with **LangGraph** and **GPT-4o-mini** that fetches up-to-date API documentation from [Context Hub (chub)](https://github.com/andrewyng/context-hub) before making the api calls to open ai — so it always works with current, accurate API knowledge instead of stale training data.
...
- [Context Hub](https://github.com/andrewyng/context-hub) — up-to-date API docs for agents
